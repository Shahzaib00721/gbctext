      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-7  ">
        <div className=''>
          ...
          <div className="flex flex-col md:flex-row gap-4 mt-8">
            ...
            <button className="bg-red-500 text-white px-6 py-3 md:py-0  rounded-[6px]  h-[40px]  lg:w-[423px] hover:bg-red-600 transition-colors">
         ...
         <div className="space-y-4">
            ...
            <div className="flex items-center gap-8 ">
              {/* France Education International Logo */}
